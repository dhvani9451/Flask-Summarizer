...
def add_slide(prs, title, content):
    ...
    # Add bullet points for each paragraph
    ...
    for filename, text in file_texts.items():
        ...
        for paragraph in structured_text:
            ...
            for wrapped_line in wrapped_lines:
                ...
                # If the slide has at least 2 paragraphs or is full, add a new slide
                if len(current_slide_text) >= 2 or len(current_slide_text) == max_lines_per_slide:
