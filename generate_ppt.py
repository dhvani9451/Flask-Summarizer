...
def add_slide(prs, title, content):
    """Adds a slide ensuring bullet points are applied based on new thoughts or line breaks."""
    ...
    # Add bullet points based on line breaks or fixed length
    for i, paragraph in enumerate(content):
        ...
        # 2. The paragraph is a new line or exceeds a certain length
        if i == 0 or len(paragraph) > 50:  # Example: Treat lines >50 chars as new thoughts
            p.level = 0  # PowerPoint's default bullet
        else:
            p.level = 1  # Indent for wrapped lines or continuous text
