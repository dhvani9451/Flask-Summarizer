...
def add_slide(prs, title, content):
    ...
    # ✅ Add Content with Selective Bullets
    ...
    for i, paragraph in enumerate(content):
        ...
        p.space_after = Pt(10)  # Ensure spacing between points

        # ✅ Add bullet after every 4-7 lines for balance
        if (i + 1) % 5 == 0:  
            p.level = 0  # Bullet Point
        else:
            p.level = 1  # No bullet, regular paragraph
