...
# ✅ Function to add slides with properly formatted text
def add_slide(prs, title, content):
    ...
    # ✅ Formatting content with bullet points & proper spacing
    for i, paragraph in enumerate(content):
        p = text_frame.add_paragraph()
        p.text = paragraph
        p.font.size = Pt(16)

        # ✅ Add spacing between paragraphs and points
        if i > 0:
            p.space_before = Pt(14)  # Space before new point/paragraph
