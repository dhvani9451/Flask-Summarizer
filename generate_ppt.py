...
def add_slide(prs, title, content):
    """Adds a new slide with title and formatted content, ensuring bullet points for each new point."""
    ...
    for paragraph in content:
        ...
        p.text = "• " + paragraph  # ✅ Ensure each new point starts with a bullet
        p.font.size = Pt(18)
        p.space_after = Pt(10)
        p.level = 0  # ✅ Ensures it's a bullet point
