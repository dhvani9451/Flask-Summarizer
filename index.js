...
async function sendToAPI(extractedText) {
  ...
  try {
    ...
    let pptUrl = "https://flask-summarizer-1-khc9.onrender.com" + data.ppt_url;

    // ✅ Store the PPT download URL in sessionStorage
    sessionStorage.setItem("pptDownloadLink", pptUrl);
    console.log("✅ PPT link stored in sessionStorage:", pptUrl);

    // ✅ Redirect to download.html after storing link
    window.location.href = "download.html";
